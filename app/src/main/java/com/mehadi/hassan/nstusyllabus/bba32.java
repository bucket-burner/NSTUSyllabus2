...
public class bba32 extends  ExpandableListActivity
{
    ...
    private ArrayList<Parent> buildDummyData()
    {
        ...
        for (int i = 1; i < 8; i++)
        {
            ...
            if(i==1){
                ...
                parent.setText2("Course Title: Auditing & Taxation\ncredit: 3.00");
...
//Add Child class object to parent class object
                ...
                parent.setText2("Course Title: Management Accounting\ncredit: 3.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setText2("Course Title: Management\nInformation System\nCredit: 2.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code: BBA 3202");
                ...
                parent.setName("" + i);
                parent.setText1("Course Code: BBA 3207");
                parent.setText2("Course Title: Entrepreneurship Development\nCredit: 3.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code: BBA 3209");
                parent.setText2("Course Title: Production\n& Operations Management\ncredit: 3.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code: BBA 3204");
    ...
    private class MyExpandableListAdapter extends BaseExpandableListAdapter
    {
        ...
        public MyExpandableListAdapter()
        {
            ...
            inflater = LayoutInflater.from(bba32.this);
        }
