...
public class amath extends AppCompatActivity {
    Button b1;
    Button b2;
    Button b3;
    Button b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amath);
        ...
        this.b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(amath.this, amath11.class);
                startActivity(i);
            }
        });
        ...
        this.b2.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(amath.this, amath12.class);
                startActivity(i);
            }
        });
        ...
        this.b3.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i= new Intent(amath.this, amath21.class);
                startActivity(i);
            }
        });
        ...
        this.b4.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(amath.this, amath22.class);
                startActivity(i);
            }
        });
        ...
        this.b5.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(amath.this, amath31.class);
                startActivity(i);
            }
        });
        ...
        this.b6.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(amath.this, amath32.class);
                startActivity(i);
            }
        });
        ...
        this.b7.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(amath.this, amath41.class);
                startActivity(i);
            }
        });
        ...
        this.b8.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(amath.this, amath42.class);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.homeid:
                Intent newActivity = new Intent(amath.this, MainActivity.class);
