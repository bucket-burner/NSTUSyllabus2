...
public class bba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bba.this, bba11.class);
                startActivity(i);
            }
        });
        ...
        this.b2.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bba.this, bba12.class);
                startActivity(i);
            }
        });
        ...
        this.b3.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i= new Intent(bba.this, bba21.class);
                startActivity(i);
            }
        });
        ...
        this.b4.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bba.this, bba22.class);
                startActivity(i);
            }
        });
        ...
        this.b5.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bba.this, bba31.class);
                startActivity(i);
            }
        });
        ...
        this.b6.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bba.this, bba32.class);
                startActivity(i);
            }
        });
        ...
        this.b7.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bba.this, bba41.class);
                startActivity(i);
            }
        });
        ...
        this.b8.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bba.this, bba42.class);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.homeid:
                Intent newActivity = new Intent(bba.this, MainActivity.class);
