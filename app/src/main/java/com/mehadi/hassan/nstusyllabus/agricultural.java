...
public class agricultural extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(agricultural.this, agri11.class);
                startActivity(i);
            }
        });
        ...
        this.b2.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(agricultural.this, agri12.class);
                startActivity(i);
            }
        });
        ...
        this.b3.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i= new Intent(agricultural.this, agri21.class);
                startActivity(i);
            }
        });
        ...
        this.b4.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(agricultural.this, agri22.class);
                startActivity(i);
            }
        });
        ...
        this.b5.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(agricultural.this, agri31.class);
                startActivity(i);
            }
        });
        ...
        this.b6.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(agricultural.this, agri32.class);
                startActivity(i);
            }
        });
        ...
        this.b7.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(agricultural.this, agri41.class);
                startActivity(i);
            }
        });
        ...
        this.b8.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(agricultural.this, agri42.class);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.homeid:
                Intent newActivity = new Intent(agricultural.this, MainActivity.class);
