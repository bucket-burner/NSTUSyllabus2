...
public class pharma31 extends  ExpandableListActivity
{
    ...
    private ArrayList<Parent> buildDummyData()
    {
        ...
        for (int i = 1; i <12; i++)
        {
            ...
            if(i==1){
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3101");
                parent.setText2("Course Title:Pharmaceutical Analysis\nand Quality Control I\nCredit:3.00");
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3102");
                parent.setText2("Course Title:Pharmaceutical Analysis\nand Quality Control I Lab\nCredit:1.00  ");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3103");
                parent.setText2("Course Title:Medicinal Chemistry I\nCredit:3.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3104");
                parent.setText2("Course Title:Medicinal Chemistry I\nLab\nCredit:1.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3105");
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3106");
                parent.setText2("Course Title:: Pharmaceutical Technology\nII Lab\nCredit:3\1.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3107");
                parent.setText2("Course Title:Pharmacology II\nCredit:3.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3108");
                parent.setText2("Course Title:Pharmacology II Lab\nCredit:1.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3109");
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3111");
                parent.setText2("Course Title:Veterinary and\nAgro-Pharmaceuticals\nCredit:2.00");
                parent.setChildren(new ArrayList<Child>());
                ...
                parent.setName("" + i);
                parent.setText1("Course Code:PHAR 3112");
                ...
                final Child child3 = new Child();
                child3.setName("" + i);
                child3.setText1("Field work:  Pharmaceutical Industry visit (a day long program)");
                parent.getChildren().add(child3);
            }
    ...
    private class MyExpandableListAdapter extends BaseExpandableListAdapter
    {
        ...
        public MyExpandableListAdapter()
        {
            ...
            inflater = LayoutInflater.from(pharma31.this);
        }
