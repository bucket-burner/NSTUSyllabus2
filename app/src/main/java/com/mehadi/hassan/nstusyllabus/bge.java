...
public class bge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bge.this, bge11.class);
                startActivity(i);
            }
        });
        ...
        this.b2.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bge.this, bge12.class);
                startActivity(i);
            }
        });
        ...
        this.b3.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i= new Intent(bge.this, bge21.class);
                startActivity(i);
            }
        });
        ...
        this.b4.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bge.this, bge22.class);
                startActivity(i);
            }
        });
        ...
        this.b5.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bge.this, bge31.class);
                startActivity(i);
            }
        });
        ...
        this.b6.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bge.this, bge32.class);
                startActivity(i);
            }
        });
        ...
        this.b7.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bge.this, bge41.class);
                startActivity(i);
            }
        });
        ...
        this.b8.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                ...
                Intent i = new Intent(bge.this, bge42.class);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.homeid:
                Intent newActivity = new Intent(bge.this, MainActivity.class);
